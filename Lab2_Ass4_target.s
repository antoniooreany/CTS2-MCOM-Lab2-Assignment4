...
LOOP:
	...
	call read_INCR_BUTTON	# subroutine read_INCR_BUTTON is called
	call read_DECR_BUTTON
...
read_INCR_BUTTON:
	...
	andi r9, r9, 0b0001	# r9 <- masked value of (0xFF200050)
	bne r9, r0, INCR_RELEASED	# Pressed: if r9!=0 => goto INCR_RELEASED
	br return_read_INCR_BUTTON
INCR_RELEASED:
	movia r9, 0xFF200050		# r9 <- 0xFF200050
	ldw r9, (r9)		# r9 <- (0xFF200050)
	andi r9, r9, 0b0001	# r9 <- masked value of (0xFF200050)
...
read_DECR_BUTTON:
	...
	movia r9, 0xFF200050		# r9 <- 0xFF200050
	ldw r9, (r9)		# r9 <- (0xFF200050)
	andi r9, r9, 0b0010	# r9 <- masked value of (0xFF200050)
	bne r9, r0, DECR_RELEASED	# Pressed: if r9!=0 => goto DECR_RELEASED
	br return_read_DECR_BUTTON
DECR_RELEASED:
	movia r9, 0xFF200050		# r9 <- 0xFF200050
	ldw r9, (r9)		# r9 <- (0xFF200050)
	andi r9, r9, 0b0010	# r9 <- masked value of (0xFF200050)
	bne r9, r0, DECR_RELEASED	# Pressed: if r9!=0 => goto DECR_RELEASED
	subi r7, r7, 1		# Pressed: COUNTER-- 
return_read_DECR_BUTTON:
	ldw r9, (sp)		# POP_r9_1
	addi sp, sp, 4		# POP_r9_2
	ret
...
read_CLEAR_BUTTON:
	...
	movia r9, 0xFF200050	# r9 <- 0xFF200050
	ldw r9, (r9)		# r9 <- (0xFF200050)
	andi r9, r9, 0b1000	# r9 <- masked value of (0xFF200050)
